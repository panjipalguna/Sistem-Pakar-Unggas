...
class Penyakit extends CI_Controller{
     ...
     * Editing a penyakit
     */
    function edit($id_penyakit)
    {   
        // check if the penyakit exists before trying to edit it
        $data['penyakit'] = $this->Penyakit_model->get_penyakit($id_penyakit);
        
        if(isset($data['penyakit']['id_penyakit']))
        {
            if(isset($_POST) && count($_POST) > 0)     
            {   
                $params = array(
                ...
                $this->Penyakit_model->update_penyakit($id_penyakit,$params);            
                redirect('penyakit/index');
            }
            else
            {
     ...
     * Deleting penyakit
     */
    function remove($id_penyakit)
    {
        $penyakit = $this->Penyakit_model->get_penyakit($id_penyakit);

        // check if the penyakit exists before trying to delete it
        if(isset($penyakit['id_penyakit']))
        {
